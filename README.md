...
Scripts to parse timeseries from assorted dataloggers in order to generate consistently formatted data with standardized metadata.
...
Supported formats from Hobo dataloggers:
